...
public class Database {
    ...
    public Database() {
        users.add(Map.of("userId", "1", "email", "alice@loglass.co.jp", "userType", "EMPLOYEE", "isEmailConfirmed", "true"));
        users.add(Map.of("userId", "2", "email", "bob@loglass.co.jp", "userType", "EMPLOYEE", "isEmailConfirmed", "false"));
        users.add(Map.of("userId", "3", "email", "michael@example.com", "userType", "CUSTOMER", "isEmailConfirmed", "true"));
        company = Map.of("numberOfEmployees", "2", "companyDomainName", "loglass.co.jp");
    }
